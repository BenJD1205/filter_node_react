...
import { Container, Grid, makeStyles, CircularProgress, Button, Paper, Typography, Slider,Radio, TextField, FormControl, RadioGroup, FormControlLabel} from '@material-ui/core'
...
const BootcampsPage = () => {
    ...
    const updateUiValue = (uiValues) => {
        ...
        if(uiValues.sorting.price){
            ...
            setPriceOrder([Number(priceSort.gte), Number(priceSort.lte)])
        }
    }
